...
def press(num):#6
    ...
    expression=expression+str(num)  # ''+'6'-> 6
...
def equalpress():
    try:
        ...
        equation.set("Please enter valid input")
...
equation=StringVar()  #entry aLabel
expression_field = Entry(gui,
                         textvariable=equation)  # allows single line text   syntax-entry = tk.Entry(parent, options)
